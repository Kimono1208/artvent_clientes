        ...
        <form class="row g-4 needs-validation" novalidate method="POST"
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('tipo') is-invalid @enderror" name="tipo" id="tipo"
                    value="{{ old('tipo', isset($cotizacion) ? $cotizacion->tipo : '') }}" required>
                @error('tipo')
                    <div class="invalid-feedback">{{ $message }}</div>
                @else
                    <div class="valid-feedback">¡Correcto!</div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('cantidad_personas') is-invalid @enderror"
                    name="cantidad_personas" id="cantidad_personas"
                    value="{{ old('cantidad_personas', isset($cotizacion) ? $cotizacion->cantidad_personas : '') }}"
                    required>
            ...
            <div class="col-md-4">
                ...
                <input type="checkbox" class="form-check-input @error('conexiones') is-invalid @enderror" name="conexiones"
                    id="conexiones"
                    {{ old('conexiones', isset($cotizacion) ? $cotizacion->conexiones : '') ? 'checked' : '' }}>
                @error('conexiones')
                    <div class="invalid-feedback">{{ $message }}</div>
                @else
                    <div class="valid-feedback">¡Correcto!</div>
            ...
            <div class="col-md-4">
                ...
                <input type="checkbox" class="form-check-input @error('cortinas') is-invalid @enderror" name="cortinas"
                    id="cortinas"
                    {{ old('cortinas', isset($cotizacion) ? $cotizacion->cortinas : '') ? 'checked' : '' }}>
                @error('cortinas')
                    <div class="invalid-feedback">{{ $message }}</div>
                @else
                    <div class="valid-feedback">¡Correcto!</div>
