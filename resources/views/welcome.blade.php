        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Mas opciones</span> <i
                                class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="#">Mas opciones 1</a></li>
                            <li class="dropdown"><a href="#"><span>Mas opciones 2</span> <i
        ...
        <section id="about" class="about">
            <div class="container-fluid">
                ...
                <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5"
                    ...
                    <p>Ofrecemos soluciones innovadoras para proporcionar sombra y confort en tus espacios exteriores.
                        Nuestros toldos están diseñados para satisfacer tus necesidades específicas, brindando elegancia
                        y funcionalidad.</p>

                    <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon"><i class="bx bx-fingerprint"></i></div>
                        <h4 class="title"><a href="#">Toldos Personalizados</a></h4>
                        <p class="description">Diseñamos y fabricamos toldos a medida para adaptarse perfectamente a tu
                            estilo y requisitos, garantizando calidad y durabilidad.</p>
                    </div>

                    <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
                        <div class="icon"><i class="bx bx-gift"></i></div>
                        <h4 class="title"><a href="#">Servicio Excepcional</a></h4>
                        <p class="description">Nuestro equipo comprometido está aquí para brindarte un servicio
                            excepcional, desde la consulta inicial hasta la instalación y el soporte continuo.</p>
                    </div>

                    <div class="icon-box" data-aos="zoom-in" data-aos-delay="300">
                        <div class="icon"><i class="bx bx-atom"></i></div>
                        <h4 class="title"><a href="#">Variedad de Estilos</a></h4>
                        <p class="description">Explora nuestra amplia gama de estilos y materiales para encontrar el
                            toldo perfecto que complemente tu espacio y refleje tu estilo único.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row content">
                    ...
                    <div class="col-md-8 pt-4" data-aos="fade-up">
                        ...
                        <p class="fst-italic">
                            Descubre cómo nuestros toldos innovadores pueden transformar tu espacio al aire libre,
                            proporcionando sombra y estilo a medida.
                        </p>
                        <ul>
                            <li><i class="bi bi-check"></i> Diseño exclusivo para una estética única.</li>
                            <li><i class="bi bi-check"></i> Materiales resistentes y duraderos para protección a largo
                                plazo.</li>
                            <li><i class="bi bi-check"></i> Fácil instalación y mantenimiento.</li>
                            <li><i class="bi bi-check"></i> Variedad de estilos y colores para adaptarse a tus
                                preferencias.</li>
                        </ul>
                        <p>
                            Transforma tu espacio al aire libre con nuestros toldos de alta calidad, diseñados para
                            satisfacer tus necesidades y añadir un toque de elegancia.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="img/testimonials/testimonial-1.jpg" class="testimonial-img"
                                    alt="Cliente 1">
                                <h3>Marta Gómez</h3>
                                <h4>Cliente Satisfecho</h4>
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Los toldos de ArtVent han transformado completamente mi patio. Son de alta calidad y
                                    el servicio al cliente es excepcional. ¡Recomiendo ArtVent a todos!
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="img/testimonials/testimonial-2.jpg" class="testimonial-img"
                                    alt="Cliente 2">
                                <h3>Juan Pérez</h3>
                                <h4>Cliente Satisfecho</h4>
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    La variedad de estilos de toldos de ArtVent me permitió encontrar la opción perfecta
                                    para mi hogar. ¡Estoy muy contento con mi elección!
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                            </div>
                        </div><!-- End testimonial item -->
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="img/testimonials/testimonial-3.jpg" class="testimonial-img"
                                    alt="Cliente 3">
                                <h3>Laura Rodríguez</h3>
                                <h4>Cliente Satisfecho</h4>
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    La instalación profesional de los toldos de ArtVent superó mis expectativas. Ahora
                                    puedo disfrutar de mi terraza sin preocuparme por el sol.
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                            </div>
                        </div><!-- End testimonial item -->
                ...
                <div class="row" data-aos="fade-left">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="member" data-aos="zoom-in" data-aos-delay="100">
                            <div class="pic"><img src="img/team/team-1.jpg" class="img-fluid" alt="Equipo 1">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="pic"><img src="img/team/team-2.jpg" class="img-fluid" alt="Equipo 2">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                        <div class="member" data-aos="zoom-in" data-aos-delay="300">
                            <div class="pic"><img src="img/team/team-3.jpg" class="img-fluid" alt="Equipo 3">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                        <div class="member" data-aos="zoom-in" data-aos-delay="400">
                            <div class="pic"><img src="img/team/team-4.jpg" class="img-fluid" alt="Equipo 4">
                            </div>
                            <div class="member-info">
                                <h4>Luis Gómez</h4>
                                <span>Contador</span>
                ...
                <div class="faq-list">
                    <ul>
                        <li data-aos="fade-up">
                            ...
                            <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">¿Qué tipos de
                                toldos existen?
                            ...
                            <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                                <p>
                                    Existen varios tipos de toldos, incluyendo toldos retráctiles, toldos fijos, toldos
                                    verticales y toldos vela. Cada tipo tiene sus propias ventajas según las necesidades
                                    específicas de sombra y protección.
                                </p>
                            </div>
                        </li>
                        ...
                        <li data-aos="fade-up" data-aos-delay="100">
                            <i class="bx bx-help-circle icon-help"></i>
                            <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">¿Cuál es la
                            ...
                            <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    La vida útil de un toldo puede variar dependiendo del material y la calidad del
                                    mismo. Generalmente, los toldos de alta calidad pueden durar entre 5 a 15 años con
                        ...
                        <li data-aos="fade-up" data-aos-delay="200">
                            <i class="bx bx-help-circle icon-help"></i>
                            <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">¿Cómo se
                                limpia y mantiene un toldo?
                                <i class="bx bx-chevron-down icon-show"></i><i
                                    class="bx bx-chevron-up icon-close"></i>
                            </a>
                            <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Para limpiar un toldo, es recomendable usar agua y jabón suave, evitando productos
                                    químicos agresivos. Se debe enjuagar bien y dejar secar completamente antes de
                                    retraerlo. Además, es importante revisar regularmente las estructuras y los
                                    mecanismos para asegurar su buen funcionamiento.
                                </p>
                            </div>
                        </li>
                        ...
                        <li data-aos="fade-up" data-aos-delay="300">
                            <i class="bx bx-help-circle icon-help"></i>
                            <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">¿Los toldos
                            ...
                            <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Muchos toldos están diseñados para ser resistentes al agua y al viento. Sin embargo,
                                    en condiciones climáticas extremas es recomendable retraer el toldo para evitar
                                    daños. Existen modelos específicos que ofrecen mayor resistencia a estos elementos.
                                </p>
                            </div>
                        </li>
                        ...
                        <li data-aos="fade-up" data-aos-delay="400">
                            <i class="bx bx-help-circle icon-help"></i>
                            <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">¿Se pueden
                                personalizar los toldos?
                                <i class="bx bx-chevron-down icon-show"></i><i
                                    class="bx bx-chevron-up icon-close"></i>
                            </a>
                            <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Sí, los toldos se pueden personalizar en cuanto a tamaño, color, material y diseño.
                                    Muchas empresas ofrecen opciones de personalización para adaptarse a las necesidades
                                    específicas y la estética del espacio donde se instalará el toldo.
                                </p>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="200">
                        <form action="{{ route('cotizacion.store') }}" method="POST" role="form"
                            class="php-email-form">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <select name="es_guadalajara" class="form-select"
                                        aria-label="Default select example" required>
                                        <option >¿Su evento es en Guadalajara?</option>
                                        <option value="si">Si</option>
                                        <option value="no">No</option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group">
                                    <select name="es_aire_libre" class="form-select"
                                        aria-label="Default select example" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <select name="es_evento_grande" class="form-select"
                                        aria-label="Default select example" required>
                                ...
                                <div class="col-md-6 form-group">
                                    <select name="es_todo_el_dia" class="form-select"
                                        aria-label="Default select example" required>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <select name="manana_o_noche" class="form-select"
                                        aria-label="Default select example" required>
                            ...
                            <div class="col-md-6 form-group">
                                <select name="temporada" class="form-select" aria-label="Default select example"
                                    required>
                    ...
                    <div class="col-lg-2 col-md-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bx bx-chevron-right"></i> <a
                                    href="/archivos/Términos y Condiciones Artvent.pdf">Términos y condiciones</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a
                                    href="/archivos/Aviso de privacidad Artvent.pdf">Política de privacidad</a></li>
                        </ul>
                    </div>
